...
def singleProductPage(Request,id):
    ...
    return render(Request,"detail.html",{'data':data,'relatedProducts':relatedProduct})
...
def paymentSuccessPage(Request,rppid,rpoid,rpsid,checkid):
    ...
    check.save()
    subject = 'Your Order Has Been Placed : Team E-cart'
    message = """
                        Hello """+buyer.name+"""
                        Your Order Has Been Placed!!!
                        Now Your Track Your Order in Profile 
                        Section
                        Team : E-Cart
                        """
    email_from = settings.EMAIL_HOST_USER
...
def contactPage(Request):
    if (Request.method=="POST"):
        ...
        c.save()
        messages.success(Request,"Thanks For Sharing Your Query With Us!!! Our Will Contact You Soon!!!")
